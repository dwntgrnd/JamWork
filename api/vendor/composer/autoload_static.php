...
class ComposerStaticInita1dca74064dcb83d7286bbc3dcc3a65d
{
    ...
    public static $classMap = array (
        ...
        'JamWork\\Bootstrap' => __DIR__ . '/../..' . '/src/Bootstrap.php',
        'JamWork\\Lib\\Auth' => __DIR__ . '/../..' . '/src/Lib/Auth.php',
        'JamWork\\Lib\\Database' => __DIR__ . '/../..' . '/src/Lib/Database.php',
        'JamWork\\Lib\\DatabaseUnavailableException' => __DIR__ . '/../..' . '/src/Lib/DatabaseUnavailableException.php',
        'JamWork\\Lib\\DatabaseUnavailableHandler' => __DIR__ . '/../..' . '/src/Lib/DatabaseUnavailableHandler.php',
        'JamWork\\Lib\\Mailer' => __DIR__ . '/../..' . '/src/Lib/Mailer.php',
        'JamWork\\Lib\\NotificationService' => __DIR__ . '/../..' . '/src/Lib/NotificationService.php',
        'JamWork\\Lib\\Validator' => __DIR__ . '/../..' . '/src/Lib/Validator.php',
        'JamWork\\Middleware\\AdminMiddleware' => __DIR__ . '/../..' . '/src/Middleware/AdminMiddleware.php',
        'JamWork\\Middleware\\AuthMiddleware' => __DIR__ . '/../..' . '/src/Middleware/AuthMiddleware.php',
        'JamWork\\Middleware\\NoCacheMiddleware' => __DIR__ . '/../..' . '/src/Middleware/NoCacheMiddleware.php',
        'JamWork\\Middleware\\RateLimitMiddleware' => __DIR__ . '/../..' . '/src/Middleware/RateLimitMiddleware.php',
        'JamWork\\Models\\TaskModel' => __DIR__ . '/../..' . '/src/Models/TaskModel.php',
        'JamWork\\Routes\\AdminRoutes' => __DIR__ . '/../..' . '/src/Routes/AdminRoutes.php',
        'JamWork\\Routes\\AuthRoutes' => __DIR__ . '/../..' . '/src/Routes/AuthRoutes.php',
        'JamWork\\Routes\\CronRoutes' => __DIR__ . '/../..' . '/src/Routes/CronRoutes.php',
        'JamWork\\Routes\\LabelRoutes' => __DIR__ . '/../..' . '/src/Routes/LabelRoutes.php',
        'JamWork\\Routes\\MilestoneRoutes' => __DIR__ . '/../..' . '/src/Routes/MilestoneRoutes.php',
        'JamWork\\Routes\\ProjectRoutes' => __DIR__ . '/../..' . '/src/Routes/ProjectRoutes.php',
        'JamWork\\Routes\\ReportRoutes' => __DIR__ . '/../..' . '/src/Routes/ReportRoutes.php',
        'JamWork\\Routes\\ReportScheduleRoutes' => __DIR__ . '/../..' . '/src/Routes/ReportScheduleRoutes.php',
        'JamWork\\Routes\\SprintRoutes' => __DIR__ . '/../..' . '/src/Routes/SprintRoutes.php',
        'JamWork\\Routes\\TaskLinkRoutes' => __DIR__ . '/../..' . '/src/Routes/TaskLinkRoutes.php',
        'JamWork\\Routes\\TaskRoutes' => __DIR__ . '/../..' . '/src/Routes/TaskRoutes.php',
        'JamWork\\Routes\\UserPreferencesRoutes' => __DIR__ . '/../..' . '/src/Routes/UserPreferencesRoutes.php',
        'JamWork\\Routes\\WorkspaceSettingsRoutes' => __DIR__ . '/../..' . '/src/Routes/WorkspaceSettingsRoutes.php',
        'JamWork\\Services\\ReportEmailRenderer' => __DIR__ . '/../..' . '/src/Services/ReportEmailRenderer.php',
        'JamWork\\Services\\ReportMarkdownRenderer' => __DIR__ . '/../..' . '/src/Services/ReportMarkdownRenderer.php',
        'JamWork\\Services\\ReportService' => __DIR__ . '/../..' . '/src/Services/ReportService.php',
        'JamWork\\Services\\ScheduleEvaluator' => __DIR__ . '/../..' . '/src/Services/ScheduleEvaluator.php',
        'JamWork\\Services\\ServiceException' => __DIR__ . '/../..' . '/src/Services/ServiceException.php',
        'JamWork\\Services\\SprintService' => __DIR__ . '/../..' . '/src/Services/SprintService.php',
        'JamWork\\Services\\TaskService' => __DIR__ . '/../..' . '/src/Services/TaskService.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInita1dca74064dcb83d7286bbc3dcc3a65d::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInita1dca74064dcb83d7286bbc3dcc3a65d::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInita1dca74064dcb83d7286bbc3dcc3a65d::$classMap;
